...
function  [TX2_signal,playMode] = TX2_create_signal( )
    ...
    %*****************  parsing TX channel data ********
    
    %  stimulus selection
    stimulusSource.pureTone = mdb.TX2.stimulus.stimulusSelect.pureTone; 
    stimulusSource.speech = mdb.TX2.stimulus.stimulusSelect.speech;
    stimulusSource.noise = mdb.TX2.stimulus.stimulusSelect.noise; 
    ...
    % noise parameters
    noiseSource = mdb.TX2.stimulus.noise.source;  % 1 = 'white noise', 2 = 'NB', 3 = 'from file'
    noiseFileName =  mdb.TX2.stimulus.noise.fileName;
    noiseNBCenterFreq =  mdb.TX2.stimulus.noise.NBCntrFrq;
    noiseNBBandWidth = mdb.TX2.stimulus.noise.NBBW;
    noiseAmp =  mdb.TX2.stimulus.noise.amp;
    noisePhase = mdb.TX2.stimulus.noise.phase;

    % pure-tone parameters
    pureToneFreq = mdb.TX2.stimulus.PT.freq;
    pureToneAmp = mdb.TX2.stimulus.PT.amp;  
    pureToneModType = mdb.TX2.stimulus.PT.modulationType;  % ,0='AM', 1='FM', 2='AM and FM', 3='no modulation'
    pureToneModADepth = mdb.TX2.stimulus.PT.modDepth;  %default AM depth = 100%, default FM index = 1
    pureToneModFreq = mdb.TX2.stimulus.PT.modFreq;
    pureTonePhase = mdb.TX2.stimulus.PT.phase;

    % speech parameters
    speechSource =  mdb.TX2.stimulus.speech.source;
    speechAmp = mdb.TX2.stimulus.speech.amp;  
    speechPhase = mdb.TX2.stimulus.speech.phase;

    % stimulus burst
    playBurst = mdb.TX2.stimulus.burstDuration;   %case 0 - countinues play or end of wav file;
    if( (playBurst == 0) )
